...
/**
 * custom_error_atoi - converts a string to an integer
...
/**
 * display_custom_error - prints an error message
...
void display_custom_error(custom_info_t *info, char *estr)
{
    ...
    _eputs(": ");
    print_custom_decimal(info->history_count, STDERR_FILENO);
    _eputs(": ");
...
/**
 * print_custom_decimal - function prints a decimal (integer) number (base 10)
 * @input: the input
...
/**
 * convert_to_custom_number - converter function, a clone of itoa
 * @num: number
 * @base: base
